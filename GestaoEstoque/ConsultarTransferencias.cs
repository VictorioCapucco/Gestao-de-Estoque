...
namespace GestaoEstoque
{
    public partial class ConsultarTransferencias : Form
    {
        ...
        public ConsultarTransferencias(Form anterior, int x, int y)
        {
        ...
        private void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            Form formConsultarTransferencia = new ConsultarTransferencias(formAnterior, posicaoForm.X, posicaoForm.Y);
            xClicked = false;
            this.Close();
